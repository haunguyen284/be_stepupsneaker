...
public class ClientCartDetailController {
    ...
    public Object findById(@PathVariable("id") String id) {
        ClientCartDetailResponse resp = clientCartDetailService.findById(UUID.fromString(id));
    ...
    public Object delete(@PathVariable("id") String id) {
        return ResponseHelper.getResponse(clientCartDetailService.delete(UUID.fromString(id)), HttpStatus.OK);
    }
